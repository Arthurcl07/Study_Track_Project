...
## Estados
- **Normal**: média ≥ 6,0 e frequência ≥ 75%.
- **Atenção**: média entre 5,0 e 5,9, com frequência ≥ 75%.
...
- IF a média do estudante estiver entre 5,0 e 5,9 E a frequência for igual ou superior a 75%, THEN o sistema SHALL transicionar a situação para Atenção. (RB-06)
- IF a média for igual ou superior a 6,0 E a frequência for igual ou superior a 75%, THEN o sistema SHALL transicionar a situação para Normal.
...
stateDiagram-v2
    ...
    Atencao --> Normal: media volta a >= 6,0 e frequencia >= 75%
