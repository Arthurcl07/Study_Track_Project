...
> Em construção — o código-fonte ainda não foi implementado (fase de requisitos e modelagem concluída). Instruções de execução serão adicionadas quando a implementação (Fase 4) começar.
...
- [Personas](./docs/persona1.md) ([e](./docs/persona2.md))
